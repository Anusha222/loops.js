...
console.log(isLowerCaseLetter("a"));//true
console.log(isLowerCaseLetter("A"));//false
...
console.log(countVowels("anusha"));//3
...
console.log(sumPrimesUpTo(2));//2
console.log(sumPrimesUpTo(7));
...
//it means position in primenumbers.
...
console.log(sumOfFirstNPrimes(2));//5
...
console.log(removeNonLetters("this is a string;it has some punctuation!"));
...
console.log(isPalindrome("anusha"));